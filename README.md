...
[![iOS PWA Ready](https://img.shields.io/badge/📱%20iOS%20PWA-Add%20to%20Home%20Screen-0284c7?style=for-the-badge&logo=apple&logoColor=white)](https://ashah404.github.io/navasan-price-dashboard/)
...
## 📱 راهنمای نصب روی آیفون (iOS Add to Home Screen)

این وب‌اپلیکیشن با استانداردهای رسمی اپل برای **iOS (iPhone & iPad)** سازگار شده است و می‌توانید آن را بدون نیاز به اپ‌استور، مانند یک اپلیکیشن واقعی روی صفحه اصلی گوشی خود نصب و اجرا کنید.

### 🌟 مزایای نصب وب‌اپ نوسان روی آیفون:
- **اجرای تمام‌صفحه (Standalone):** بدون مزاحمت نوار آدرس سافاری یا دکمه‌های مرورگر.
- **دسترسی سریع و مستقیم:** قرارگیری آیکون باکیفیت و اختصاصی نوسان روی هوم اسکرین.
- **لود فوق‌سریع و کش آفلاین:** حفظ اطلاعات قبلی حتی هنگام قطعی موقت اینترنت.
- **پشتیبانی از Safe Area:** هماهنگی کامل طراحی با ناچ (Notch) و داینامیک آیلند آیفون.

### 📌 مراحل ۳ گانه نصب در مرورگر Safari:
۱. سایت را در مرورگر **Safari** آیفون باز کنید.  
۲. در نوار پایین مرورگر روی دکمه‌ی **اشتراک‌گذاری (Share ⎋)** لمس کنید.  
۳. در منوی باز شده به پایین اسکرول کرده و گزینه **«Add to Home Screen» (افزودن به صفحه اصلی ➕)** را انتخاب نمایید.  
۴. در گوشه بالا سمت راست روی **«Add» (افزودن)** بزنید تا آیکون برنامه در صفحه اصلی گوشی شما قرار گیرد.

> 💡 **راهنمای درون‌برنامه:** در داخل خود سایت نیز دکمه **«📱 نصب وب‌اپ»** در هدر و بنر هوشمند راهنما تعبیه شده است که این مراحل را به صورت تصویری نمایش می‌دهد.

---

## ✨ سایر امکانات و قابلیت‌های کلیدی
